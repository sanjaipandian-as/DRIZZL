            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <div className="max-w-xl space-y-4">
                        <h2 className="text-gold-500 font-bold tracking-[0.3em] uppercase text-sm">
                            Capture the Moment
                        </h2>
                        <h3 className="font-display text-5xl md:text-7xl text-coffee-900 leading-tight">
                            VISUAL <span className="text-gold-500">JOURNEY</span>
                        </h3>
                    </div>
                    <p className="text-coffee-600 text-lg max-w-sm mb-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px] md:h-[800px]">
                    ...
                    <div className="col-span-2 row-span-2 relative group overflow-hidden rounded-3xl">
                        ...
                        />
                        <div className="absolute inset-0 bg-coffee-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                            <span className="text-white font-display text-3xl tracking-widest uppercase">{GALLERY_IMAGES[0].title}</span>
                        </div>
                    </div>
                    ...
                    <div className="relative group overflow-hidden rounded-3xl">
                        ...
                        />
                        <div className="absolute inset-0 bg-coffee-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                            <span className="text-white font-display text-xl tracking-widest uppercase">{GALLERY_IMAGES[1].title}</span>
                        </div>
                    </div>
                    ...
                    <div className="relative group overflow-hidden rounded-3xl">
                        ...
                        />
                        <div className="absolute inset-0 bg-coffee-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                            <span className="text-white font-display text-xl tracking-widest uppercase">{GALLERY_IMAGES[2].title}</span>
                        </div>
                    </div>
                    ...
                    <div className="col-span-2 relative group overflow-hidden rounded-3xl">
                        ...
                        />
                        <div className="absolute inset-0 bg-coffee-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
                            <span className="text-white font-display text-2xl tracking-widest uppercase">{GALLERY_IMAGES[3].title}</span>
                        </div>
                    </div>
                </div>
            </div>
